...
/* Den viktigaste formeln visas direkt efter inledningen i de fysikkort där
   ett centralt samband finns. Begrepps- och metodkort lämnas utan formelruta. */
(() => {
  const formler = {
    "Beräkna densitet":"\\[\\rho=\\frac{m}{V}\\]",
    "Beräkna massa från densitet":"\\[m=\\rho V\\]",
    "Omvandla densitet":"\\[1\\ \\mathrm{g/cm^3}=1000\\ \\mathrm{kg/m^3}\\]",
    "Volym och densitet hos ett rätblock":"\\[V=lbh,\\qquad \\rho=\\frac{m}{V}\\]",
    "Densitet från mätningar":"\\[\\rho=\\frac{\\Delta m}{\\Delta V}\\]",
    "Rörelse med konstant hastighet":"\\[s=s_0+vt\\]",
    "Medelfart":"\\[v_m=\\frac{\\Delta s}{\\Delta t}\\]",
    "Beräkna acceleration":"\\[a=\\frac{\\Delta v}{\\Delta t}\\]",
    "Hastighet efter en viss tid":"\\[v=v_0+at\\]",
    "Sträcka vid konstant acceleration":"\\[s=v_0t+\\frac{at^2}{2}\\]",
    "Fritt fall från vila":"\\[s=\\frac{gt^2}{2}\\]",
    "Läs ett läge–tid-diagram":"\\[v=\\frac{\\Delta s}{\\Delta t}\\]",
    "Läs ett hastighet–tid-diagram":"\\[\\Delta s=\\text{arean under }v\\text{–}t\\text{-grafen}\\]",
    "Reaktionssträcka":"\\[s=vt\\]",
    "Resulterande kraft":"\\[F_R=\\sum F\\]",
    "Newtons andra lag":"\\[F_R=ma\\]",
    "Massa och tyngdkraft":"\\[F_g=mg\\]",
    "Dela upp en kraft i komposanter":"\\[F_x=F\\cos\\alpha,\\qquad F_y=F\\sin\\alpha\\]",
    "Glidfriktion":"\\[F_f=\\mu N\\]",
    "Vilofriktion":"\\[F_f\\leq \\mu_sN\\]",
    "Fjäderkraft":"\\[F=kx\\]",
    "Kraftmoment":"\\[M=Fl\\]",
    "Jämvikt på en hävstång":"\\[M_{medurs}=M_{moturs}\\]",
    "Mekaniskt arbete":"\\[W=Fs\\]",
    "Lägesenergi":"\\[E_p=mgh\\]",
    "Rörelseenergi":"\\[E_k=\\frac{mv^2}{2}\\]",
    "Energiprincipen":"\\[E_{före}=E_{efter}\\]",
    "Arbete mot friktion":"\\[W=F_fs\\]",
    "Beräkna effekt":"\\[P=\\frac{W}{t}\\]",
    "Energi från effekt och tid":"\\[E=Pt\\]",
    "Verkningsgrad":"\\[\\eta=\\frac{E_{nyttig}}{E_{tillförd}}\\]",
    "Rörelsemängd":"\\[p=mv\\]",
    "Impuls":"\\[F\\Delta t=\\Delta p\\]",
    "Rörelsemängd vid en kollision":"\\[p_{före}=p_{efter}\\]",
    "Tryck är kraft per area":"\\[p=\\frac FA\\]",
    "Vätsketryck":"\\[p=\\rho gh\\]",
    "Totalt tryck under vatten":"\\[p_{tot}=p_{atm}+\\rho gh\\]",
    "Temperatur i kelvin":"\\[T=t_{^\\circ C}+273{,}15\\]",
    "Tryck och volym hos en gas":"\\[p_1V_1=p_2V_2\\]",
    "Tryck och temperatur hos en gas":"\\[\\frac{p_1}{T_1}=\\frac{p_2}{T_2}\\]",
    "Lyftkraft i vatten":"\\[F_L=\\rho gV\\]",
    "Flyta eller sjunka":"\\[F_L=F_g\\quad\\text{vid jämvikt}\\]",
    "Energi för att värma ett ämne":"\\[Q=cm\\Delta T\\]",
    "Smältning":"\\[Q=ml_s\\]",
    "Förångning":"\\[Q=ml_å\\]",
    "Värmebalans":"\\[Q_{avgiven}=Q_{upptagen}\\]",
    "Antal elektroner och laddning":"\\[Q=Ne\\]",
    "Elektrisk kraft mellan laddningar":"\\[F=k\\frac{|Q_1Q_2|}{r^2}\\]",
    "Vad är elektrisk ström?":"\\[I=\\frac Qt\\]",
    "Spänning och energi":"\\[U=\\frac EQ\\]",
    "Ohms lag":"\\[U=RI\\]",
    "Resistorer i serie":"\\[R=R_1+R_2+\\cdots\\]",
    "Resistorer parallellt":"\\[\\frac1R=\\frac1{R_1}+\\frac1{R_2}+\\cdots\\]",
    "Ersättningsresistans parallellt":"\\[\\frac1R=\\frac1{R_1}+\\frac1{R_2}+\\cdots\\]",
    "Elektrisk effekt":"\\[P=UI\\]",
    "Elektriskt fält mellan plattor":"\\[E=\\frac Ud\\]",
    "Kraft på en laddning i ett fält":"\\[F=QE\\]",
    "Skriv ett alfasönderfall":"\\[{}^{A}_{Z}X\\rightarrow{}^{A-4}_{Z-2}Y+{}^{4}_{2}\\mathrm{He}\\]",
    "Skriv ett beta-minus-sönderfall":"\\[{}^{A}_{Z}X\\rightarrow{}^{A}_{Z+1}Y+{}^{0}_{-1}e+\\bar\\nu_e\\]",
    "Skriv ett beta-plus-sönderfall":"\\[{}^{A}_{Z}X\\rightarrow{}^{A}_{Z-1}Y+{}^{0}_{+1}e+\\nu_e\\]",
    "Massdefekt vid alfasönderfall":"\\[\\Delta m=m_{före}-m_{efter},\\qquad E=\\Delta mc^2\\]",
    "Aktivitet och halveringstid":"\\[A=A_0\\left(\\frac12\\right)^{t/T_{1/2}}\\]",
    "Absorberad dos":"\\[D=\\frac Em\\]",
    "Ekvivalent dos":"\\[H=w_RD\\]",
    "Massa och energi":"\\[E=\\Delta mc^2\\]",
    "Elektromagnetiska spektrumet":"\\[c=f\\lambda\\]",
    "Verkningsgrad och energiresurser":"\\[\\eta=\\frac{E_{nyttig}}{E_{tillförd}}\\]"
  };
  Object.values(window.TYPUPPGIFTER_FY1).forEach(g=>{
