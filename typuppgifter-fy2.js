...
(() => {
  ...
  const cirkelFigur = '<svg viewBox="0 0 360 190" role="img" aria-label="Cirkelrörelse med tangentiell hastighet och acceleration mot centrum"><circle class="dg-linje" cx="180" cy="98" r="62"/><circle class="dg-vald" cx="242" cy="98" r="6"/><line class="dg-hjalp" x1="180" y1="98" x2="242" y2="98"/><line class="dg-pil" x1="242" y1="98" x2="242" y2="40"/><line class="dg-pil" x1="242" y1="98" x2="190" y2="98"/><text class="dg-txt" x="251" y="43">v</text><text class="dg-txt" x="205" y="88">a</text><text class="dg-txt" x="207" y="116">r</text></svg>';
  ...
  add(1,"cirkel","Riktningarna i en cirkelrörelse","<p>En bil kör med konstant fart uppåt förbi den högra punkten på en cirkelbana. Åt vilka håll pekar hastigheten och accelerationen?</p>","Vid konstant fart ändras ändå hastigheten, eftersom dess riktning ändras.",[
    steg("Rita hastigheten","Hastigheten är tangent till banan och pekar i rörelseriktningen.","\\[\\vec v:\\quad \\text{tangent åt vänster}\\]",cirkelFigur),
